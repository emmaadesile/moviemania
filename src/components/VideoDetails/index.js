...
const VideoDetails = ({ uri }) => {
  ...
  useEffect(() => {
    ...
    fetchVideoDetails();
  }, [videoDetailsEndpoint, videoTrailerEndpoint, uri]);
...
// // get the props for fetching the video details
// const getVideoProps = (): {
//   videoDetailsEndpoint: string;
//   videoTrailerEndpoint: string;
// } => {
//   const { pathname } = window.location;
//   const videoId = pathname.replace(/[\D]/g, "");
...
// const VideoDetails = ({ uri }: { uri: string }) => {
//   const initialVideoDetails = {
//     vote_average: "",
//     backdrop_path: "",
//     overview: "",
